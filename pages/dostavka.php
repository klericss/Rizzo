    ...
    <main>
        <section class="container my-5">
            <div class="caption d-flex flex-column align-items-center">
                <h2 class="text-center">Доставка и оплата</h2>      
                <div style="height: 2px; background-color: #852cf5; width: 400px; margin: 0 auto; margin-bottom: 60px; margin-top: 40px;"></div> 
                <img class="mb-5 img-fluid" src="../img/dostavka.jpg" alt="dostavka" width="600"> 
            </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">
                        <p><strong>Курьерская доставка в пределах МКАД</strong> 1-2 дня</p>
                        <hr>
                        <p><strong>Пункты самовывоза Boxberry</strong> 1-3 дня</p>
                        <hr>
                        <p><strong>Курьерская доставка по Москве за пределы МКАД</strong></p>
                        <p>Зависит от удаленности от МКАД и будет окончательно рассчитана при оформлении заказа. Если у адреса есть дополнительный населенный пункт, пожалуйста, укажите его в поле выше.</p>
                    </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">
                        ...
                        <p>Оплата производится наличными в рублях в момент получения заказа. Способ оплаты доступен только для курьерской доставки в пределах МКАД.</p>
                        <hr>
                        <p><strong>Банковской картой онлайн</strong></p>
                        <p>Безопасная онлайн оплата банковскими картами Visa, MasterСard и Мир. Заказ поступает в обработку только после успешной оплаты.</p>
                        <hr>
                        <p><strong>Безналичный расчет (юрлица, ИП)</strong></p>
                        <p>Счет на оплату будет отправлен вам автоматически после оформления заказа. Заказ поступает в обработку только после поступления оплаты.</p>
                    </div>
                    </div>
                </div>
                </div>    
