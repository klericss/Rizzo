      ...
      <div class="col-lg-6">
            ...
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <h5 class="my-3">Паша Кубыркин</h5>
                    <p class="text-muted mb-4">Староватутинский пр д.6</p>
                </div>
            </div>
      ...
      <div class="col-lg-12 text-center">
        <div class="card mb-4">
          <div class="card-body">
                ...
                <div class="col-sm-9">
                    <p class="text-muted mb-0">Паша Кубыркин</p>
                </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="col-sm-9">
                    <p class="text-muted mb-0">dsghdfh@gmail.com</p>
                </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="col-sm-9">
                    <p class="text-muted mb-0">+7 954-543-54-34</p>
                </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="col-sm-9">
                    <p class="text-muted mb-0">Староватутинский пр д.6</p>
                </div>
                </div>
          </div>
        </div>
