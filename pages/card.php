    ...
    <main>
        ...
        <div class="card mb-3 border-0">
          <div class="row g-0">
            ...
            <div class="col-md-6">
              <div class="card-body">
                <h1 class="card-title">Varmilo Chang'e 87</h1>
                <p class="light">Артикул: BM1SM</p>
                <p class="fw-bold fs-3"> 11 400 руб.</p>
                <button type="button" class="btn btn-primary w-50 mb-3 p-2">В коризну</button>
                <p class="fw-bold fs-4">Характеристики</p>
                <p>Материал клавиш: PBT</p>
                <hr>
                <p>Конструкция: классическая</p>
                <hr>
                <p>Размер - 80%</p>
                <hr>
                <p>Цифровой блок - нет</p>
                <hr>
                <p>Стабилизаторы: Cherry</p>
                <hr>
                <p>Подсветка: белая</p>
                <hr>
                <p>Тип разъема: Mini-USB</p>
                <hr>
                <p>Длина кабеля: 1.8 метра</p>
              </div>
            </div>
          </div>
        </div>
